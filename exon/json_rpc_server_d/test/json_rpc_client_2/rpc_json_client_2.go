...
func main() {
	...
	// Floods the Server with 'User.Modify' Requests.
	...
	var args Arguments
	var result_modify ModifyResult
	...
	for {
		...
		args.UUID = i
		args.LOGIN = "Modified Login #" + strconv.FormatUint(i, 10)

		// Call remote Procedure
		err = client.Call(funcName, args, &result_modify)
		...
		//fmt.Print("Results:", result_modify, "\r\n\r\n") //dbg
