...
func main() {
	...
	// Floods the Server with 'User.Get' Requests.
	// Another Test must fill the DataBase before this Test.
	...
	for {
		...
		args.UUID = i
		args.LOGIN = ""
		login_expected = "Modified Login #" + strconv.FormatUint(i, 10)

		// Call remote Procedure
		err = client.Call(funcName, args, &result_get)
		...
		//fmt.Print("Results:", result_get, "\r\n\r\n") //dbg
		if login_expected != result_get.LOGIN {
			fmt.Println("Un-Expected Login received!", result_get.LOGIN) //dbg
		}
